...
- **La portada lleva el Índice de la casa.** Pedido por Ernesto el 22 de septiembre de 2026. La portada explicaba de dónde viene el nombre y no decía qué hay dentro, y seis de las diez puertas del menú no dicen lo que guardan: nadie que llegue por primera vez sabe que Tinta-ciones es la poesía ni que Laureles son los premios. La salida **no** es un texto que explique cómo leer la web, que en la portada de un escritor se lee como una disculpa, sino un índice que sea la propia navegación, con **una cifra por sala**: la cifra dice el tamaño antes de entrar y da una razón para abrir esa puerta y no otra. El orden es el del menú, a propósito, para no obligar a aprenderse dos. Lo escribe `herramientas/gen-portada.py` entre los marcadores `<!-- indice -->`, y las cifras se cuentan de los manifiestos: una obra nueva cambia el número sola y el comprobador falla si la portada se queda atrás.
- **`/en/author/` es el concentrador de toda la obra.** Quién es el autor, su hoja de servicios completa y, por géneros, las catorce obras publicadas, los veintidós trabajos de prensa, los once cuentos, los veinte poemas, las veinte décimas y las cuatro novelas inéditas, cada uno enlazado. Estructura pedida por Ernesto el 22 de septiembre de 2026. **Las listas no se escriben en `ingles.json`**: las arma `gen-ingles.py` desde los mismos manifiestos que el sitio, con el tipo de sección `obras`. Escribirlas a mano sería tener el dato dos veces, y el segundo envejecería sin que nadie lo notara.
...
- **De nueve trabajos no consta dónde salieron y se publican igual, callando el medio.** Decisión de Ernesto, 22 de septiembre de 2026, tomada sabiendo que ocho de los nueve son reseñas de 2013 y 2014 al ritmo de una columna mensual, y que eso los pone cerca de una publicación que está fuera de lista. La lista de los nueve está en `PENDIENTES.md`, a la espera de que Tony diga de dónde son; el que resulte ser de esa publicación se retira.

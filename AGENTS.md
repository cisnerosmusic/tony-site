...
- **Los cuentos de Contarte entran sin línea de presentación**: título y al texto.
...
- **La dedicatoria y el epígrafe de un texto van declarados en el manifiesto**, nunca adivinados: una dedicatoria de cuatro líneas y un primer párrafo corto se parecen demasiado. El generador se para si el texto no trae exactamente lo declarado. La línea sigue viva en el índice de Contarte, que es donde sirve para escoger.
